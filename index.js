...
const brit = new Instructor({
  ...
  age: 36,
  location: 'Ontario',
  specialty: 'giving notes',
  favLanguage: 'Python',
  catchPhrase: 'because thats the rule'
});

console.log('task 4', brit.grade(student, 'web dev'));
console.log('task 4', brit.demo('web dev'));
console.log('task 4', brit.speak());
...
const mikey = new Student({
  name: 'Mikey',
  age: 26,
  location: 'Mars',
  specialty: 'making cookies',
  favLanguage: 'French',
  catchPhrase: 'oh well!',
...
mikey.listSubjects();
mikey.PRAssignment('art');
mikey.sprintChallenge('music');


console.log('task 5', mikey.PRAssignment('art'));
console.log('task 5', mikey.listSubjects());
console.log('task 5', mikey.sprintChallenge('music'));
